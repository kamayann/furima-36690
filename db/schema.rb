...
ActiveRecord::Schema.define(version: 2021_11_15_011509) do
  ...
  create_table "buyer_informations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_record_id"], name: "index_buyer_informations_on_purchase_record_id"
  end
  ...
  add_foreign_key "buyer_informations", "purchase_records"
